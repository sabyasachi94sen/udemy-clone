...
export function EditAdminRole({onClick1,onClick2,onClick3}: EditAdminRoleProps){

    return (
    <div className="w-[34%] h-[65vh] rounded-xl bg-[#FDFEFF] border-2 relative z-10 -mt-[110vh] mx-auto">
        <div className="w-[90%] h-[10vh] mx-auto flex justify-around items-center">
          ...
          <h1 className="text-4xl text-[#3AB0FB] font-bold mr-16">Edit an Super Admin role</h1>
        </div>
        ...
        <div className="mx-auto w-28 mt-64">
