    ...
    <div className="relative z-10 mx-auto -mt-[150vh] h-auto w-[90%] rounded-xl border-2 bg-[#FDFEFF]">
        ...
        <div className="relative mt-10 flex h-[12vh] w-[90%] justify-between">
          ...
          <div className="flex w-[30%] flex-col items-start text-lg font-bold">
            ...
            <input
              ...
              defaultValue={
                title != "Add a student to the roster"
                  ? individualStudentData?.date_of_birth
                  : null
              }
              disabled={title == "View a student to the roster"}
            />
          ...
          <div className="ml-20 flex w-[30%] flex-col items-start text-lg font-bold">
            ...
            <input
              ...
              defaultValue={
                title != "Add a student to the roster"
                  ? individualStudentData?.current_grade
                  : null
              }
              disabled={title == "View a student to the roster"}
            />
        ...
        <div className="relative mt-10 flex h-[12vh] w-[90%] justify-between">
          <div className="flex w-[45%] flex-col items-start text-lg font-bold">
            ...
            >
              ...
              <option selected={title != "Add a student to the roster"}>
                India
              </option>
            </select>
          </div>
          <div className="flex w-[30%] flex-col items-start text-lg font-bold">
            ...
            <input
              ...
              defaultValue={
                title != "Add a student to the roster"
                  ? individualStudentData?.student_city_residence[0]
                      ?.city_of_residence
                  : null
              }
              disabled={title == "View a student to the roster"}
                ...
                data.map((item, index) => (
                  <option
                    ...
                    selected={
                      !!(
                        title != "Add a student to the roster" &&
                        individualStudentData?.student_assignment[0]
                          ?.account_manager?.username == item?.username
                      )
                    }
                    value={item.id}
                  >
              ...
              {activeOptions.map((item, index) => (
                <option
                  ...
                  selected={
                    !!(
                      title != "Add a student to the roster" &&
                      ((individualStudentData?.is_active &&
                        item.value == "active") ||
                        (!individualStudentData?.is_active &&
                          item.value == "inactive"))
                    )
      ...
      <div className="relative mt-10 flex h-[12vh] w-[70%] justify-between">
        <div className="flex w-[80%] flex-col items-start text-lg font-bold">
          ...
          <input
            ...
            defaultValue={
              title != "Add a student to the roster"
                ? individualStudentData?.student_assignment[0]?.account_manager
                    .email
                : null
            }
            disabled={title == "View a student to the roster"}
        ...
        <div className="flex w-[80%] flex-col items-start text-lg font-bold">
          ...
          <input
            ...
            defaultValue={
              title != "Add a student to the roster"
                ? individualStudentData?.phone_number
                : null
            }
            disabled={title == "View a student to the roster"}
          />
      ...
      <div className="mx-auto mt-7 h-[20vh] w-[50%] text-center text-lg font-bold">
        ...
        <textarea
          ...
          defaultValue={individualStudentData?.remarks}
          disabled={title == "View a student to the roster"}
        />
      </div>
