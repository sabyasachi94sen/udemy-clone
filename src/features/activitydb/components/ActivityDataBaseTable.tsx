        ...
        <div className="w-[90%] h-screen rounded-md bg-white -mt-44">
           ...
           <div>
            ...
            <div className="w-[100%] h-[6vh] flex items-center justify-around mt-6 z-0">
              ...
              <button className="bg-cyan-500 rounded-md w-[7%] h-[6vh] text-[18px] text-center flex justify-center items-center text-white hover:bg-blue-600">Add&nbsp; <img alt="plus-icon" src="/images/plus.png" /> </button>
            </div>
