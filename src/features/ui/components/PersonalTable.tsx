  ...
  return (
    <div className="-mt-44 h-screen w-[90%] rounded-md bg-white">
      <div>
        ...
        <div className="z-0 mt-6 flex h-[6vh] w-[100%] items-center pl-[7%]">
                ...
                activityData.map((val, index) => (
                  ...
                  >
                    ...
                    <td className="h-[6vh] w-[25%]">
                      {val && val?.activity_count}
                    </td>
                    <td className="h-[6vh] w-[25%]">
                      {moment(val && val?.last_update).format("YYYY-MM-DD")}
                    </td>
                    <td className="h-[6vh] w-[25%]">
                      <div className="flex items-center justify-center text-[#3AB0FB]">
                        ...
                        <div className="ml-3 h-[2vh] w-[35%] rounded-full bg-gray-200 dark:bg-gray-700">
                          <div className="h-[2vh] w-[45%] rounded-full bg-[#3AB0FB] p-0.5 text-center text-xs font-medium leading-none text-blue-100" />
                        </div>
                      </div>
                    </td>
                  </tr>
