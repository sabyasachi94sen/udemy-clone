  ...
  const storeFormData=(e)=>{
   ...
   return <form>
     ...
     <div className="bg-white w-96 h-auto p-6 rounded-lg shadow-lg relative left-[70px] z-10 mt-28">
       ...
       <label className="text-lg font-medium text-gray-900 dark:text-gray-300" >Password</label>
       ...
       <div className="mb-6 flex justify-between h-7">
         <div>
           <label className="block text-gray-500 font-bold text" >
             ...
             <span className="text-md ml-2">Remember me</span>
           </label>
         </div>
         <Link href="/reset-password"><p className="text-[#0ea5e9] font-sans cursor-pointer">Forgot password?</p></Link>
