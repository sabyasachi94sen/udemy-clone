 ...
 export function ActiveStatus({onClick1,header}: ActiveStatusProps){
    ...
    return(
        <div className="w-[84%] h-auto bg-white border-2 rounded-xl font-sans pb-10 pt-5 relative z-20 mx-auto -mt-[135vh] border-[#3AB0FB]">
            ...
            <div className="flex mx-auto w-[15%] h-[5vh] text-center border-2 border-[#3AB0FB] mt-8 mb-2">
                <button className={!isStatus?`bg-[#3AB0FB] w-[50%] text-white`: `bg-white w-[50%] text-[#344054]`} onClick={checkIsStatus}>Yes</button>
                <button className={!isStatus?`w-[50%] text-[#344054] bg-white`: `w-[50%] bg-[#3AB0FB] text-white`} onClick={checkIsStatus}>No</button>
            ...
            <button className="bg-[#3AB0FB] text-center w-[10%] h-[5vh] mx-auto block mt-6 rounded-md text-white" onClick={onClick1}>Ok</button>
