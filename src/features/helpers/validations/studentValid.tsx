...
export const studentValid=yup.object({
    ...
    phone_number: yup.string().min(10).required("Password should be atleast 10 digits").required("Phone number is a required field"),
    ...
    is_active:yup.string().required("Active Status is a required field")
