...
export function Navbar() {
  return (
    <div className="flex h-[12vh] w-full items-center bg-cyan-500">
      <div className="flex h-[12vh] w-[65%] items-center justify-around">
        <h1 className="text-[2rem] font-bold text-white">PIPPAMS</h1>
        <div className="flex h-[6vh] w-[70%] items-center justify-around">
          <div className="flex h-[6vh] w-[80%] items-center rounded-md bg-white pl-4">
            <input
              className="h-[6vh] w-[90%] bg-white pl-7 placeholder-gray-600 outline-none"
              name="search"
              placeholder="search"
              type="text"
            />
          ...
          <div className="flex h-[5vh] w-10 cursor-pointer items-center justify-center rounded-md border-2 border-cyan-400 bg-cyan-400">
            <img alt="bell-icon" src="/images/bell.png" />
          </div>
        </div>
      </div>

      <div className="ml-[5vw] flex items-center justify-around md:w-[45%] lg:w-[40%] xl:w-[30%] xl:pr-3 2xl:w-[26%]">
        <img
          alt="user-image"
          className="h-[60px] w-[60px] rounded-[50%] border-2 border-white"
