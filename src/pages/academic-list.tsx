...
import {AcademicTable,AcademicPersonalTable,AddActivityForm} from "@/features/academic_plan"
...
function AcademicPlan(){
    ...
    return(
        ...
        <div className="flex items-center z-0">
          ...
          <AcademicPersonalTable onClick1={isAddActive} onClick2={deleteDataInTable} activityData={storeActivityData} />}
...
<div className="w-full h-[170vh] -mt-[155vh] flex justify-center relative z-10">
  <AddActivityForm onClick1={addDataInTable} onClick2={isAddActive} activeData={storeActivityData}/>
  </div>
: ""}
