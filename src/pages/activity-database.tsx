...
function Activity() {
  ...
  const handleBackgroundBlurOnEdit = (individual_activity_info:object,activity_id: string) => {
  ...
  const editActivityData=(formVal: FormValues)=>{
    ...
    setMutateParams({ mutateFunc: ActivityResObj.activity_edit,action: "edit" })
