...
export function ResetPasswordOTPForm(){
    ...
    return <div className="bg-white w-[21%] h-auto p-6 rounded-lg shadow-lg relative ml-[16.5vw] mt-[3vh] left-[1vw] z-10">
      ...
      <div className="mx-auto mb-[9vh] flex justify-center">
